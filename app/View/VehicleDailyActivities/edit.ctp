...
<?php echo $this->Form->create('VehicleDailyActivity'); ?>
	<fieldset>
		<legend><?php echo __('Edit Vehicle Daily Activity'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('VehicleDailyActivity.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('VehicleDailyActivity.id'))); ?></li>
