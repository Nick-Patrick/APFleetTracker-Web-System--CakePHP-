<div class="packages index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('special_reqs'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($package['Package']['length']); ?>&nbsp;</td>
		<td><?php echo h($package['Package']['width']); ?>&nbsp;</td>
		<td><?php echo h($package['Package']['weight']); ?>&nbsp;</td>
		<td><?php echo h($package['Package']['special_reqs']); ?>&nbsp;</td>
